...
const UserCard = ({ fullName, username, profileImg }) => {
  return (
    <div className="user-card relative w-[200px] h-[220px] lg:w-[250px] lg:h-[260px] bg-[rgba(255,255,255,0.1)] flex-shrink-0 rounded-2xl overflow-hidden md:w-[220px] md:h-[240px]">
