    ...
    <>
      ...
      <section className="relative flex gap-10 lg:px-20 py-0 m-0 max-md:flex-col">
        <div className="sticky top-[80px] z-30">
          <div className="min-w-[250px] h-cover md:sticky py-5 top-24 overflow-y-auto md:pr-0 max-md:backdrop-blur-lg max-md:bg-black/10 absolute max-md:top-[64px] max-md:w-[calc(100%+50px)] max-md:px-16 max-md:-ml-7">
