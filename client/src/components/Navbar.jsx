        ...
        {userAuth.access_token ? (
          <>
            ...
            <Link to={`/${userAuth.username}`}>
              <div className="active bg-[#fff]/10 w-[46px] xsm:h-[46px]  sm:w-[56px] sm:h-[46px] rounded-[0.8rem] xsm:rounded-xl sm:rounded-2xl cursor-pointer mouseenter overflow-hidden">
                <img
