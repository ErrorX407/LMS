...
const CommentsContainer = () => {
  ...
  return (
    <div className={"comment-container max-sm:w-full fixed "+ (commentWrapper ? "top-0 sm:right-0" : "top-[100%] sm:right-[-100%]") +" duration-700 max-sm:right-0 sm:top-0 md:w-[50%] lg:w-[30%] mix-w-[350px] h-full z-[1000] bg-black/80 backdrop-blur-2xl shadow-2xl p-8 px-5 overflow-y-auto overflow-x-hidden"}>
