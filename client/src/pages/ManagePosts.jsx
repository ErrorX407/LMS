...
import {
  ManageDraftPostCard,
  ManagePostCard,
} from "../components/ManagePostCard";
...
const ManagePosts = () => {
  ...
  return (
    <div className="w-full mt-[50px] md:mt-0 lg:mt-0">
      ...
      <div className="relative max-md:mt-5 md:mt-8 mb-5 md:mb-10">
        <input
          type="search"
        ...
        <button
          ...
          className="bg-purple text-black rounded-[1rem] w-[50px] h-[50px] absolute ml-3 top-1/2 -translate-y-1/2 hover:scale-95 active:scale-90"
        >
              ...
              <div className="grid grid-cols-2 gap-x-0 gap-y-10 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5">
                {drafts.results.posts.map((post, i) => {
                  return (
                    ...
                    >
                      <ManageDraftPostCard
                        post={{ ...post, index: i, setStateFun: setDrafts }}
                      />
                    </motion.div>
                  );
                })}
